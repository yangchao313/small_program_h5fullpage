...
Page({
  ...
  submitClick: function (e) {
    ...
    if (test.t1v == '' && test.form.t1full == '1' && test.form.t1show =='1'){
      this.notice(test.form.t1name+'不能为空!');
      istrue=false;
      return false;
    }
    if (test.t2v == '' && test.form.t2full == '1' && test.form.t2show == '1') {
      this.notice(test.form.t2name + '不能为空!');
      istrue = false;
      return false;
    }
    if (test.t3v == '' && test.form.t3full == '1' && test.form.t3show == '1') {
      this.notice(test.form.t3name + '不能为空!');
      istrue = false;
      return false;
    }
    if (test.t4v == '' && test.form.t4full == '1' && test.form.t4show == '1') {
      this.notice(test.form.t4name + '不能为空!');
      istrue = false;
      return false;
    }

    if (test.rv == '' && test.form.rfull == '1' && test.form.rshow == '1') {
      this.notice(test.form.rname + '不能为空!');
      istrue = false;
      return false;
    }
    if (test.cv == '' && test.form.cfull == '1' && test.form.cshow == '1') {
      this.notice(test.form.cname + '不能为空!');
      istrue = false;
      return false;
    }
  
    if (test.av == '' && test.form.afull == '1' && test.form.ashow == '1') {
